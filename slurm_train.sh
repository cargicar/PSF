...
module load conda
conda activate psf
module load gcc cudatoolkit pytorch
module load gcc
...
#python sample_flow.py --category airplane --model output/train_flow/2025-10-23-17-34-22/epoch_999.pth --distribution_type single
python train_flow_g4.py 