...
def get_output_dir_scaling(prefix, exp_id, type='scaling'):
    #t = datetime.datetime.now().strftime('%Y-%m-%d-%H-%M-%S')
    output_dir = os.path.join(prefix, 'output/' + exp_id, type)
...
def main():
    ...
    type= 'pvcnn2_' + str(opt.npoints)
    output_dir = get_output_dir_scaling(dir_id, exp_id, type=type)
...
def parse_args():
    ...
    parser.add_argument('--dataroot', default='/pscratch/sd/c/ccardona/datasets/G4_individual_sims_pkl_e_liquidArgon_50_subset/')
